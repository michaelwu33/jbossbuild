...
do
	...
	echo "    bank standard. Usually it is under /bns with proper ownership and "
	echo "    permission."
	echo
	read -p "Please specify a home directory for application (e.g. /bns/<app-home>): " APP_HOME
...
# Doc test
#TARBALL=/bns/michwu/src/jboss.tar.gz
#APP_HOME=/bns/michwu
#MSO_USER=michwumso
#RUN_USER=michwurun
#GRP_USER=michwugrp
#HOME_RUN_USER=/bns/michwu/home/michwurun
...
echo "JBOSS_CONFIG=standalone.xml" >> $ENVFILE
...
EOF
    ...
    then
        ...
        #su - $RUN_USER -c /bns/michwu/src/Middleware/scripts/jboss-setup.bash
		break
